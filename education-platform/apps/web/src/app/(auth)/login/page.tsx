...
import { loginSchema, LoginFormData } from "../../../schema/auth/loginSchema";
      ...
      <div className="card-form">
        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="form">
          ...
          <div className="forgot-row">
            <a href="/forgetPass" className={role === "parent" ? "forgot-link" : "forgot-link-child"}>
              Forgot Password?
            </a>
          </div>

          {/* Submit */}
          <button type="submit" disabled={isPending} className={role === "parent" ? "btn-primary" : "btn-primary-child"}>
            {isPending ? (
          ...
          <p className="signup-text">
            ...
            <a href="/register" className={role === "parent" ? "signup-link" : "signup-link-child"}>
              Sign Up
            </a>
          </p>
        </form>
